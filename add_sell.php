...
$sql6 = "SELECT * FROM  customber_login ORDER BY username ";
...
if (isset($_POST['submit'])) {
    ...
    //$old_blance1 = $old_blance + $balance_amount;
    $amtsqla = "SELECT balance_amount FROM bill  WHERE client_id='$client_name'";
    $gsmrA1 = mysqli_query($connect, $amtsqla);
    $asd = mysqli_fetch_assoc($gsmrA1);
    $old_blance1 = $asd['balance_amount'];
    $balance_amount1 = $old_blance + $balance_amount;
    
    // $amtsqla = "UPDATE bill SET balance_amount='0' WHERE client_id='$client_name'";
    // $gsmrA = mysqli_query($connect, $amtsqla);
    
    // $sqlwq="UPDATE stock SET weight='".$weight."', quantity='".$quantity."' ";
    // $resultwq = mysqli_query($connect, $sqlwq);
    
    $sqlqw = "SELECT * FROM stock ";
    $quantweight = mysqli_query($connect, $sqlqw);
    $qw = mysqli_fetch_assoc($quantweight);

    $sqlc="UPDATE invoice SET slip='".$bill_no."' WHERE id='1'";
    $resultp = mysqli_query($connect, $sqlc);

    $sqla = "INSERT INTO  `bill` (`discount`,`hsn`,`date`,`bill_no`,`material_name`,`client_name`,`grand_total`,`old_blance`,`client_id`, `godown_name`, `color`, `gsm`, `quantity`, `weight`, `rate`, `amount`, `cutting_charge`, `printing_charge`,`fright`, `gst`, `total_amount`, `balance_amount`, `paid_amount`, `taken_by` ,`pay_mode`, `note` ) VALUES('$discount','$hsn','$orderDate','$bill_no','$material_name','$client_id','$grand_total','$balance_amount','$client_name', '$godown_name', '$color', '$gsm', '$quantity', '$weight', '$rate', '$amount', '$cutting_charge', '$printing_charge', '$fright','$gst' , '$total_amount' , '$balance_amount1', '$paid_amount', '$taken_by', '$pay_mode', '$note') ";
...
<div class="container">
                            ...
                            <div>
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="text" name="client_name" id="client1" list="client" style="width: 100%;"  required/>
                                         <datalist id="client">
                ...
                <div class="col box roll selectt">
                    <div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="hsn" id="hsn" style="width: 100%;" readonly>
                ...
                <div class="col box bag selectt">
                    <div>
                           <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-4 col-form-label">HSN code</label>
                            <div class="col-sm-8">
                                <input  type= "text" name="hsn" id="hsn1" style="width: 100%;" readonly>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                ...
                                <input type="text" class="form-control" id="weight1" value="0" name="weight1" autocomplete="off">
                                 <!--<input type="text" class="form-control-plaintext" id="fweight" value="/ <?php echo $qw['weight']; ?>" name="weight" Readonly>-->
                   ...
                   <script type="text/javascript">
                    ...
                    function weight()
                    {
                        ...
                        //   alert(weight);
                         ...
                         $.ajax({
                          type:'post',
                          url:'fetch_weight.php',
                          data:{ godown:godown, material:material, color:color, gsm:gsm},
                        //   dataType:"json",
                          success:function(response) {
                            //   alert(weight);
                              
                            $("#fweight").val(response.weight);
                ...
                <div class="col-sm-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="rate1" value="0" name="rate1"  autocomplete="off">
                            </div>
                        </div>
            ...
            <div class="row box bag selectt">
                <div class="col-sm-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <label for="quantity" class="col-sm-6 col-form-label">Quantity</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="quantity" value="0" name="quantity"  autocomplete="off">
                            </div>
                        </div>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            <label for="rate" class="col-sm-6 col-form-label">Rate(per kg)</label>
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="rate" value="0" name="rate" autocomplete="off">
                            </div>
                        </div>
             ...
             <div>
                     <button class="btn btn-primary" type="button" id="save12" name="add" style="width: 100px">ADD</button>
                      <!-- <button class="btn btn-primary" type="button" id="save112" name="add" style="width: 100px">sub</button>-->
                </div>
                ...
                <div class="col-sm-3 d-none">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="gst" name="gst" autocomplete="off">
                            </div>
                        </div>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="gst_amount" value="0" name="gst_amount" autocomplete="off" >
                            </div>
                        </div>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" value="0" id="cutting_charge" name="cutting_charge" autocomplete="off">
                            </div>
                        </div>
 ...
 <script type="text/javascript">
                        ...
                        $.ajax({
                          ...
                          success:function(response) {
                            if(response.done==1)
                            {
                                ...
                                $("tbody").append(`<tr class="tr`+response.idis+`"><td>`+id+`</td><td>`+godown_name+`</td><td>`+other+`</td><td>`+color+`</td><td>`+gsm+`</td><td>`+hsn+`</td><td>`+quantity+`</td><td>`+weight1+`</td><td>`+rate1+`</td><td>`+mult+`</td><td>`+gst+`</td><td class="amount`+response.idis+`">`+gst_amount+`</td><td><button class="btn btn-primary" onclick="removethis(`+response.idis+`)">delete</button></td></tr>`);
                                id = parseFloat(id)+1;
                                $("#id").val(id);
                ...
                <script>
                      $("#save112").on("click", function(){
                          
                                //   var gst_amount = (gst_amount)-100;
                ...
                <div class="col-sm-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" value="0" id="discount" name="discount" autocomplete="off">
                            </div>
                        </div>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="paid_amount" name="paid_amount" autocomplete="off" required>
                            </div>
                        </div>
                ...
                <div class="col-sm-3">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-6">
                                <input type="text" class="form-control" id="taken_by" name="taken_by" autocomplete="off">
                            </div>
                        </div>
...
function removethis(id){
                          ...
                          success:function(response) {
                              ...
                              var gst_amount = $("#gst_amount").val();
                                ...
                                // var gst_amount = $("#gst_amount").val();
                                  ...
                                  $("#gst_amount").val(gst_amount-amount);
                                  $("#total_amount").val(total_amount-amount);
                                  $("#grand_total").val(grand_total- amount);
                                  $("#balance_amount").val(balance_amount -amount);
                          }
    ...
    // var asdf = $("#gst_amount").val();
    //                             gst_amount =  parseFloat(gst_amount) - 100;
    //                             gst_amount= (gst_amount).toFixed(2);
    //                             $("#gst_amount").val(gst_amount);
    //                             $("#total_amount").val(gst_amount);
    //                             $("#grand_total").val(gst_amount);
...
<script>
    ...
    $("#other").on("change keyup click", function(){
     ...
     $("#godown_name").on("change keyup click", function(){
        //alert("sjf");
        var godown = $("#godown_name").val();
        $.ajax({
            type: "POST",
            url: "material_entry_godown.php",
            data: {
             godown: godown
            },
            success: function(response) {
...
<script>
               $("#client1").on("change keyup", function(){
                   var username = $("#client1").val();
                   $.ajax({
                     type: "POST",
                     url: "client_sort.php",
                     dataType: "json",
