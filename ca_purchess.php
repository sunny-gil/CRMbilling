...
if(isset($_POST['from_date']))
{
    ...
    $sqlbil= "SELECT * FROM sealer_bill WHERE orderDate >= '".$from_date1."' AND orderDate <= '".$to_date."'  ORDER BY id DESC ";
...
<!-- fullCalendar 2.2.5-->
    ...
    <div class="container">
        ...
        <section>
            <div class="card">
                <div class="card-header" style="text-align: center"><h4> <u>CA Transaction (Purchase)</u></h4></div>
                ...
                <div  class="tbl" style="overflow-x:auto;">
                    <table class="table" id="example" class="display nowrap" style="width:100%">
                          ...
                          ?>
                                ...
                                <td><?php echo $row["sealer_name"]; ?></td>
                                <td><?php echo $row["total_amount"]; ?></td>
                                <td><?php if($row["pay_state"]==1){ if($row["gst"]!=''){echo $row["gst"]/2;}else{echo 0;} } else{
                                    echo 0;
                                } ?></td>
                                <td><?php if($row["pay_state"]==1){ if($row["gst"]!=''){echo $row["gst"]/2;}else{echo 0;} } else{
                                    echo 0;
                                } ?></td>
                                <td><?php if($row["pay_state"]==2){ if($row["gst"]!=''){echo $row["gst"];}else{echo 0;} } else{
                                    echo 0;
                                } ?></td>
